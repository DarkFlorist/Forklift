...
export const RepV1Migration = ({ updateTokenBalancesSignal, maybeReadClient, maybeWriteClient, showUnexpectedError }: RepV1MigrationProps) => {
	...
	return <div class = 'subApplication'>
		<section class = 'subApplication-card'>
			...
			<span> If you still hold Reputation V1 tokens, you can migrate it to Reputation V2 here. If a fork occurs on Augur V2, any Reputation V1 that has not been migrated will no longer be usable.</span>
			{ repV1Info }
