...
// 		const client = createWriteClient(mockWindow, TEST_ADDRESSES[0], 0)
// 		const market1 = await getAugurConstantProductMarketAddress(client, await deployAugurConstantProductMarket(client))
// 		const market2 = await getAugurConstantProductMarketAddress(client, await deployAugurConstantProductMarket(client, true, true))
// 		const market3 = await getAugurConstantProductMarketAddress(client, await deployAugurConstantProductMarket(client, true, true))
// 		const market4 = await getAugurConstantProductMarketAddress(client, await deployAugurConstantProductMarket(client, true, true))
// 		const market5 = await getAugurConstantProductMarketAddress(client, await deployAugurConstantProductMarket(client, true, true))
